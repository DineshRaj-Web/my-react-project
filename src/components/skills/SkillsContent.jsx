...
const SkillsContent = () => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Digital Grid */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff03_1px,transparent_1px),linear-gradient(to_bottom,#ffffff03_1px,transparent_1px)] bg-[size:30px_30px] [mask-image:radial-gradient(ellipse_80%_60%_at_50%_20%,#000_60%,transparent_100%)]" />
        ...
        <motion.div
          ...
          className="absolute inset-x-0 h-px bg-gradient-to-r from-transparent via-cyan-500/30 to-transparent shadow-[0_0_15px_rgba(6,182,212,0.3)]"
        />

        {/* Ambient Glows */}
        <div className="absolute top-10 left-1/3 w-[300px] h-[300px] bg-cyan-500/5 rounded-full blur-[100px] animate-pulse" />
        <div className="absolute bottom-20 right-1/3 w-[250px] h-[250px] bg-purple-500/5 rounded-full blur-[100px] animate-pulse" />
      ...
      <div className="relative z-10">
        <div className="mb-20">
          ...
          >
            ...
            >
              <motion.span
                className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 via-purple-400 to-cyan-300 bg-300% animate-gradient"
                animate={{
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-cyan-300 via-purple-400 to-cyan-300 bg-clip-text text-transparent">
            Technical Arsenal
          </h2>
        </motion.div>
          ...
          <div className="space-y-12 md:space-y-16 relative">
            {skillCategories.map((category, index) => (
              ...
              >
                ...
                >
                  <div className="relative p-6 md:p-8 bg-gradient-to-br from-white/12 via-white/6 to-transparent border border-white/15 rounded-2xl backdrop-blur-sm overflow-hidden transition-all duration-300 group-hover:border-cyan-300/40 group-hover:bg-gradient-to-br group-hover:from-cyan-500/8 group-hover:via-blue-500/4 group-hover:to-purple-500/6">
                    ...
                    <div className="relative z-10">
                      ...
                      >
                        ...
                        <span className="text-sm text-cyan-300 font-mono bg-gradient-to-r from-cyan-900/30 to-purple-900/30 px-3 py-1 rounded-full border border-cyan-300/30 group-hover:border-cyan-300/50 transition-all duration-300">
                        ...
                        <div className="ml-10 space-y-1">
                          {category.items.map((item, itemIndex) => (
                            <motion.div
                              ...
                              animate={{ opacity: 1, x: 0 }}
                              transition={{ duration: 0.6, delay: itemIndex * 0.08 + index * 0.1 }}
                            ...
                            >
                              ...
                              <motion.span
                                ...
                                whileHover={{ textShadow: "0 0 8px rgba(6, 182, 212, 0.6)" }}
                              >
                                {item}
                                <motion.div
                                  className="absolute inset-0 bg-gradient-to-r from-cyan-500/0 via-cyan-500/15 to-cyan-500/0 opacity-0 group-hover/item:opacity-100 transition-opacity duration-300"
                                  initial={{ x: "-100%" }}
                                  whileHover={{ x: "100%" }}

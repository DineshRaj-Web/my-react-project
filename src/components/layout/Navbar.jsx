    ...
    <>
      ...
      >
        ...
        <motion.div
          ...
          className="hidden lg:flex pointer-events-auto px-2 py-2 bg-black/40 backdrop-blur-xl border border-white/10 rounded-full shadow-2xl items-center gap-1"
        >
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className="lg:hidden absolute top-20 right-4 left-4 pointer-events-auto bg-black/95 backdrop-blur-2xl rounded-[2rem] border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.8)] overflow-hidden z-50 p-1"
            >
              {/* HUD Corner Brackets */}
              <div className="absolute top-0 left-0 w-12 h-12 border-t border-l border-cyan-500/30 rounded-tl-[2rem] pointer-events-none" />
              <div className="absolute bottom-0 right-0 w-12 h-12 border-b border-r border-purple-500/30 rounded-br-[2rem] pointer-events-none" />
                  ...
                  <div className="text-right">
                    ...
                    <div className="w-12 h-1 bg-white/5 rounded-full overflow-hidden">
                      <motion.div
                        ...
                        className="h-full bg-gradient-to-r from-cyan-500 to-purple-500 shadow-[0_0_8px_rgba(6,182,212,0.5)]" />
                    </div>
                  </div>
                </div>

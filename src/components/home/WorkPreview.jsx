...
const ProjectCard = ({ project, index }) => {
    return (
        <motion.div
            ...
            className="group relative bg-white/[0.02] backdrop-blur-md border border-white/10 rounded-[2.5rem] overflow-hidden transition-all duration-700 hover:border-cyan-500/30 hover:shadow-[0_0_40px_rgba(34,211,238,0.1)] cursor-pointer"
        >
            {/* Corner HUD Accents */}
            ...
            <div className="p-8 md:p-12 flex flex-col h-full relative">
                ...
                <div className="flex justify-between items-start mb-8">
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-center gap-2">
                            <span className={`h-1.5 w-1.5 rounded-full bg-gradient-to-r ${project.color} animate-pulse`} />
                ...
                <div className="space-y-6">
                    ...
                    <div className="relative">
                        <div className="absolute -left-6 top-0 bottom-0 w-[2px] bg-gradient-to-b from-cyan-500/40 via-transparent to-transparent opacity-20 group-hover:opacity-100 transition-opacity duration-700" />
                ...
                <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-20 md:mb-28 gap-12">
                    ...
                    >
                        ...
                        <h1 className="text-[2.75rem] md:text-8xl font-black tracking-tighter uppercase italic text-white leading-[1.1] md:leading-none">
                            Selected <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-white/40 to-transparent">CASE STUDIES.</span>
                        </h1>
                    </motion.div>

...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen px-6 md:px-16 pt-32 pb-16 flex flex-col md:flex-row items-center justify-center overflow-hidden bg-[var(--bg)] text-[var(--text)]">
        ...
        >
          <Link to="/work" className="cursor-pointer w-full md:w-auto">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="group relative w-full md:w-auto px-10 py-5 md:py-4 bg-cyan-500/5 border border-cyan-500/20 text-cyan-400 font-black text-[0.65rem] md:text-xs uppercase tracking-[0.3em] overflow-hidden transition-all duration-300 hover:bg-cyan-500/10 hover:border-cyan-500/60 cursor-pointer shadow-[0_0_20px_rgba(6,182,212,0.1)] hover:shadow-[0_0_30px_rgba(6,182,212,0.2)]"
            >
              {/* Scanline Sweep */}
          ...
          <Link to="/contact" className="cursor-pointer w-full md:w-auto">
            <motion.button
              whileHover={{ scale: 1.02, y: -2 }}
              whileTap={{ scale: 0.98 }}
              className="group relative w-full md:w-auto px-10 py-5 md:py-4 bg-white/[0.03] border border-white/10 text-white font-black text-[0.65rem] md:text-xs uppercase tracking-[0.3em] overflow-hidden transition-all duration-300 hover:bg-white/10 hover:border-white/30 cursor-pointer"
            >
        ...
        >
          <div className="flex items-center gap-2 font-mono text-[0.6rem] md:text-xs">
            ...
            <div className="relative px-3 py-1 bg-cyan-600/5 border border-cyan-500/20 rounded-sm overflow-hidden group/shopify">
              ...
              <span className="text-cyan-400 font-black tracking-[0.1em]">SHOPIFY_APP_SYSTEMS</span>
            </div>
          </div>
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/20 to-purple-600/20 rounded-full blur-3xl opacity-20 animate-pulse" />

        ...
        <div className="py-24 relative">
            ...
            >
                ...
                <h1 className="text-[2.75rem] md:text-8xl font-black mb-6 md:mb-8 tracking-tighter uppercase italic text-white leading-[1.1] md:leading-none">
                    Operational <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-white/40 to-transparent">Trace</span>
                </h1>
            ...
            <div className="relative">
                ...
                <div className="absolute left-6 md:left-6 top-0 bottom-0 w-[1px] md:w-px bg-white/5 block">
                    <motion.div
                        animate={{ top: ['0%', '100%'] }}
                        transition={{ duration: 4, repeat: Infinity, ease: "linear" }}
                        className="absolute left-0 w-[2px] md:w-[3px] -translate-x-1/2 h-20 bg-gradient-to-b from-transparent via-cyan-400 to-transparent shadow-[0_0_15px_rgba(34,211,238,0.5)]"
                    />
                </div>
                    ...
                    {experiences.map((exp, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <motion.div
                                    whileTap={{ scale: 0.98 }}
                                    className="relative bg-white/[0.02] backdrop-blur-md border border-white/10 rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-14 overflow-hidden transition-all duration-1000 hover:border-white/20"
                                >
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex flex-wrap items-center gap-4 text-[0.6rem] font-black tracking-[0.4em] uppercase text-gray-500">
                                                <div className="flex items-center gap-2.5 px-3 py-1.5 bg-cyan-500/5 border border-white/10 rounded-full backdrop-blur-sm group-hover:bg-cyan-500/10 group-hover:border-cyan-500/40 transition-all duration-700">
                                                    ...
                                                    <span className="text-white text-[0.6rem] font-black tracking-[0.1em]">{exp.period}</span>
                                                </div>

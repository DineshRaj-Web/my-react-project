  ...
  return (
    ...
    >
      ...
      <div className="relative h-full p-8 rounded-2xl bg-gradient-to-br from-white/5 via-white/3 to-transparent border border-white/10 backdrop-blur-sm overflow-hidden transition-all duration-300 group-hover:border-cyan-400/30 group-hover:bg-gradient-to-br group-hover:from-cyan-500/5 group-hover:via-blue-500/3 group-hover:to-purple-500/5">
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center justify-between mb-6">
            <motion.div
              ...
              className="w-12 h-12 rounded-full bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border border-cyan-400/30 flex items-center justify-center"
            >
            ...
            <motion.div
              ...
              className="flex-1 h-px bg-gradient-to-r from-cyan-400/50 to-transparent ml-4"
            />
          </div>
        ...
        {/* Subtle Inner Glow */}
        <div className="absolute inset-4 rounded-xl bg-gradient-to-br from-transparent via-cyan-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
      </div>
    </motion.div>
  );
};
